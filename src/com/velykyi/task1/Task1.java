package com.velykyi.task1;

public class Task1 {

    public static void main(String[] args) {
	// write your code here
        Figure[] figures = {new Rectangle(5,4),
                            new RectangularTriangle(30,100),
...
class RectangularTriangle implements Figure{
